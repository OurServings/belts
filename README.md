[![Node.js CI](https://github.com/OurServings/belts/actions/workflows/publish.yml/badge.svg)](https://github.com/OurServings/belts/actions/workflows/publish.yml)
...
You can see the latest releases in the Github repository at https://github.com/OurServings/belts/releases
...
Or go directly to https://www.npmjs.com/package/@ourservings/belts

To install the node module package use the following:

```
$ npm i @ourservings/belts
```
